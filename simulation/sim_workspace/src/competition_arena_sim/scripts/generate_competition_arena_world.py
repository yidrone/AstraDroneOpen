...
STATIC_WORLD_PATH = WORLDS_ROOT / "competition_arena" / "competition_arena.world"
RUNTIME_WORLD_PATH = WORLDS_ROOT / "generated" / "competition_arena_runtime.world"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate a randomized competition_arena runtime world.")
