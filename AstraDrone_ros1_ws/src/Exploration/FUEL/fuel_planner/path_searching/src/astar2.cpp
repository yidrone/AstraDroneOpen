...
void Astar::init(ros::NodeHandle& nh, const EDTEnvironment::Ptr& env) {
  ...
  max_time_backup_ = max_search_time_;
...
void Astar::SetMaxsearchTime(double t_max){
  max_search_time_ = t_max;
}

void Astar::ResetMaxsearchTime(){
  max_search_time_ = max_time_backup_;
}
