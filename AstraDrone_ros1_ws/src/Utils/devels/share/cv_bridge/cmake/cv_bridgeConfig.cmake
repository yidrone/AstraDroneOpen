...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/luli/AstraDrone/AstraDrone_ros1_ws/src/Utils/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/luli/AstraDrone/AstraDrone_ros1_ws/devel)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/luli/AstraDrone/AstraDrone_ros1_ws/install)
...
if(NOT "/home/luli/AstraDrone/AstraDrone_ros1_ws/src/Utils/cv_bridge/include;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/luli/AstraDrone/AstraDrone_ros1_ws/src/Utils/cv_bridge/include;/usr/local/include;/usr/local/include/opencv")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/luli/AstraDrone/AstraDrone_ros1_ws/src/Utils/cv_bridge/${idir}'.  ${_report}")
    endif()
    _list_append_unique(cv_bridge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cv_bridge;/usr/local/lib/libopencv_calib3d.so.3.4.8;/usr/local/lib/libopencv_dnn.so.3.4.8;/usr/local/lib/libopencv_features2d.so.3.4.8;/usr/local/lib/libopencv_flann.so.3.4.8;/usr/local/lib/libopencv_highgui.so.3.4.8;/usr/local/lib/libopencv_ml.so.3.4.8;/usr/local/lib/libopencv_objdetect.so.3.4.8;/usr/local/lib/libopencv_photo.so.3.4.8;/usr/local/lib/libopencv_shape.so.3.4.8;/usr/local/lib/libopencv_stitching.so.3.4.8;/usr/local/lib/libopencv_superres.so.3.4.8;/usr/local/lib/libopencv_video.so.3.4.8;/usr/local/lib/libopencv_videoio.so.3.4.8;/usr/local/lib/libopencv_videostab.so.3.4.8;/usr/local/lib/libopencv_viz.so.3.4.8;/usr/local/lib/libopencv_core.so.3.4.8;/usr/local/lib/libopencv_imgproc.so.3.4.8;/usr/local/lib/libopencv_imgcodecs.so.3.4.8")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/luli/AstraDrone/AstraDrone_ros1_ws/devel/lib;/home/luli/utils_ws/devel/lib;/home/luli/sim_env_ws/devel/lib;/opt/ros/noetic/lib)
